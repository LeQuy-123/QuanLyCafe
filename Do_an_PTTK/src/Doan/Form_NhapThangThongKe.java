 ...
 * @author MSI2
 */
public class Form_NhapThangThongKe extends javax.swing.JFrame {
    static public String str;

    /**
     * Creates new form Form_NhapThangThongKe
     */
    public Form_NhapThangThongKe( ) {
        initComponents();
    }
    ...
    private void btThongKeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btThongKeActionPerformed
        ...
        try {
            ...
            Logger.getLogger(Form_NhapThangThongKe.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Form_NhapThangThongKe().setVisible(true);
            }
        });
    }
