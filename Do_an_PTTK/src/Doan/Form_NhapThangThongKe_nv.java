 ...
 * @author MSI2
 */
public class Form_NhapThangThongKe_nv extends javax.swing.JFrame {
    static public String str;

    /**
     * Creates new form Form_NhapThangThongKe_nv
     */
    public Form_NhapThangThongKe_nv( ) {
        initComponents();
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
            ThongKe_nv_GUI gui = new ThongKe_nv_GUI();
            gui.setVisible(true);
            this.dispose();
    ...
    private void btThongKeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btThongKeActionPerformed
        ...
        String dir = "D:\\Download\\ThongKe\\Report\\ThongKeBanHangTheoThang.jrxml";
        String pdf = "D:\\Download\\ThongKe\\Report\\ThongKeBanHangTheoThang.pdf";
        try {
            JasperDesign jd = JRXmlLoader.load(dir);
        } catch (JRException ex) {
            Logger.getLogger(Form_NhapThangThongKe_nv.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Form_NhapThangThongKe_nv().setVisible(true);
            }
        });
    }
